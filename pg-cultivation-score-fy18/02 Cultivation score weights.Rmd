...
holdout_inds <- xval_inds[1]
xval_inds <- xval_inds[2:k]
# Results
c(holdout_inds, xval_inds) %>% summary
```

Group 1 is the holdout set, and the other `r {k - 1} %>% I()` will be used for cross-validation.
...
# Campaign linear model


# Campaign linear model with all predictors


# Largest transaction linear model


# Largest transaction linear model with all predictors
