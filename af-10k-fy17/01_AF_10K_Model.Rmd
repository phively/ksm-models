...
```{r load.data}
### Import the data
full.data <- read.csv('data/2017-12-08 AF 10K Model.csv', stringsAsFactors = FALSE, strip.white = TRUE,
...
### Numeric variables second look

Consider discretizing:
GIFTS_CASH
GIFTS_CREDIT_CARD
GIFTS_STOCK (binary?)
GIFT_CLUB_BEQUEST_YRS (binary?)
COMMITTEE_KSM_LDR
KSM_EVENTS_REUNIONS
KSM_SPEAKER_YEARS (binary?)
KSM_SPEAKER_TIMES
KSM_FEATURED_COMM_YEARS

GIFT_CLUB_LOYAL_YRS - how many per lvl
GIFT_CLUB_NU_LDR_YRS - same
VISITS - does it look better on sqrt or log scale
VISITORS_PFY1-5 - try combining multi years of counts
GIVING_MAX_CASH_AMT - piecewise linear?
