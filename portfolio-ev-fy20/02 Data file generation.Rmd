...
# Biodata tables
bio_phone <- fileloader('2020-03-27 phone numbers.xlsx', 1)
...
# Giving entities
  ...
  # Payments actually won't work as initially conceived because PLEDGE_NUMBER can't be used as an index
  # add_entity(
  # giv_payments
  # , entity_id = 'giv_payments'
  # , make_index = TRUE
  # , index = 'giv_payments_idx'
  # , time_index = 'PLEDGE_DATE'
  # )
# Prospect entities
  add_entity(
